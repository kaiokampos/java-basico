...
import com.kaiokampos.exercicios.entities.Comment;
import com.kaiokampos.exercicios.entities.Post;
...
public class ProgramPost {
    public static void main(String[] args) throws ParseException {
        ...
        Post p2 = new Post(sdf.parse("28/07/2018 23:14:19"), "Goode night guys", "See you tomorrow", 5);
        p2.addComment(c3);
        p2.addComment(c4);
